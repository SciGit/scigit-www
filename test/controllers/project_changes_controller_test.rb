...
class ProjectChangesControllerTest < ActionController::TestCase
  ...
  test "should update project_change" do
    patch :update, id: @project_change, project_change: { commit_hash: @project_change.commit_hash, commit_msg: @project_change.commit_msg, commit_timestamp: @project_change.commit_timestamp, project_id: @project_change.project_id, user_id: @project_change.user_id }
    assert_redirected_to project_change_path(assigns(:project_change))
  end
