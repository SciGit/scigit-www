...
(function() {
  ...
  $(document).on('ready page:load', function() {
    ...
    $('.project').click(function(e) {
      if (e.target === this || e.target.tagName.toLowerCase === 'div') {
        return Turbolinks.visit('/projects/' + this.getAttribute('data-proj_id'));
      }
    });
    return $('.change').click(function(e) {
      if (e.target === this || e.target.tagName.toLowerCase === 'div') {
        return Turbolinks.visit('/changes/view/' + this.getAttribute('data-change_id'));
      }
    });
  });
...
(function() {
  var fetchAndAppendChanges, fetchingChanges, project_id;
